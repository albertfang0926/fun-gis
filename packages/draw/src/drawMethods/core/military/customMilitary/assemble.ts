...
import { computeAssemblePoints } from "../utils/creatMilitary"
...
const drawAssemble = (viewer: Viewer, options: Record<string, any>, callback: (e:any)=>void, cancelCallback?: ()=>void) => {
  // 解析参数
  ...
  _handler.setInputAction((move: ScreenSpaceEventHandler.MotionEvent) => {
    ...
    tempLinePositions = computeAssemblePoints([...controlPoints, coor])
