...
class Sector {
  ...
  public draw(): void {
    drawCustomMilitary(this.viewer, { title: "扇形" }, (e) => {
      ...
      // this.controlPoints[2] = coordinateToCartesian3(e.positions[e.positions.length - 2], this.viewer)
      this.primitive = e.p
      console.log("controls", this.controlPoints)
    })
  }
