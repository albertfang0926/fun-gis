...
class Segment {
      ...
      if (
        ...
        this.dragHandler.setInputAction((e: any) => {
          ...
          if (position) {
            ...
            const newPrimitive = getPrimitive(this.controlPoints, { uuid: this.id }, true, this.width, this.color)
  ...
  updateWidth(width: number) {
    this.width = width
    const newPrimitive = getPrimitive(this.controlPoints, this.id, true, width, this.color)
    itemManager.updatePrimitive(this.id, newPrimitive)
  }
  ...
  updatePositions(positions: Coordinate[]) {
    ...
    const newPrimitive = getPrimitive(this.controlPoints, this.id, true, this.width, this.color)
    itemManager.updatePrimitive(this.id, newPrimitive)
  }
}
